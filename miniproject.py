...
class Student:
	...
	def __init__(self,root):
		self.root = root
		self.root.title("Matrix Glitch")
		self.root.geometry("1350x700+0+0")

		title = Label(self.root,text="Student Database Management System",bd=10,relief = GROOVE,font=("arial",40,"bold"),bg="gold",fg="black")
		...
		d_title = Label(Detail_Frame, text="ENTER THE DETAILS",bg='azure' ,fg="black" ,font=("arial", 20, "bold"))
		d_title.grid(row=0,columnspan=2,pady=10)

		lbl_roll = Label(Detail_Frame, text="ROLL NO.", bg="azure", fg="black",font=("arial", 15, "bold"))
		lbl_roll.grid(row=1, column=0, pady=10,padx=20,sticky="w")

		txt_Roll = Entry(Detail_Frame,textvariable=self.Roll_No_var, font=("arial", 15, "bold"),bd=5,relief=GROOVE)
		txt_Roll.grid(row=1,column=1,pady=10,padx=20,sticky="w")

		lbl_Name = Label(Detail_Frame, text="NAME", bg="azure", fg="black",font=("arial",15, "bold"))
		lbl_Name.grid(row=2, column=0, pady=10, padx=20, sticky="w")

		txt_Name = Entry(Detail_Frame,textvariable=self.name_var, font=("arial", 15, "bold"), bd=5, relief=GROOVE)
		txt_Name.grid(row=2, column=1, pady=10, padx=20, sticky="w")

		lbl_Email = Label(Detail_Frame, text="EMAIL", bg="azure", fg="black",font=("arial", 15, "bold"))
		lbl_Email.grid(row=3, column=0, pady=10, padx=20, sticky="w")

		txt_Email = Entry(Detail_Frame, textvariable=self.email_var,font=("arial", 15, "bold"), bd=5, relief=GROOVE)
		txt_Email.grid(row=3, column=1, pady=10, padx=20, sticky="w")

		lbl_Gender = Label(Detail_Frame, text="GENDER", bg="azure", fg="black",font=("arial", 15, "bold"))
		lbl_Gender.grid(row=4, column=0, pady=10, padx=20, sticky="w")

		combo_Gender = ttk.Combobox(Detail_Frame,textvariable=self.gender_var, font=("arial", 15, "bold"))
		combo_Gender['values'] = ("MALE","FEMALE","OTHERS")
		combo_Gender.grid(row=4, column=1, pady=10, padx=20, sticky="w")

		lbl_Contact = Label(Detail_Frame, text="CONTACT", bg="azure", fg="black",font=("arial", 15, "bold"))
		lbl_Contact.grid(row=5, column=0, pady=10, padx=20, sticky="w")

		txt_Contact = Entry(Detail_Frame, textvariable=self.contact_var,font=("arial", 15, "bold"), bd=5, relief=GROOVE)
		txt_Contact.grid(row=5, column=1, pady=10, padx=20, sticky="w")

		lbl_Dob = Label(Detail_Frame, text="D.O.B", bg="azure", fg="black",font=("arial",15, "bold"))
		lbl_Dob.grid(row=6, column=0, pady=10, padx=20, sticky="w")

		txt_Dob = Entry(Detail_Frame, textvariable=self.dob_var,font=("arial", 15, "bold"), bd=5, relief=GROOVE)
		txt_Dob.grid(row=6, column=1, pady=10, padx=20, sticky="w")

		lbl_Address = Label(Detail_Frame, text="ADDRESS", bg="azure", fg="black",font=("arial", 15, "bold"))
		lbl_Address.grid(row=7, column=0, pady=10, padx=20, sticky="w")

		self.txt_Address = Text(Detail_Frame,width=30, height=4 , font=("arial",10,"bold"),bd=5, relief=GROOVE)
		self.txt_Address.grid(row=7, column=1, pady=10, padx=20, sticky="w")

   #*******BUTTON FRAME*******
		btn_Frame = Frame(Detail_Frame,bd=4,relief=RIDGE,bg="green")
...
#*******DISPLAY FRAME*****
		...
		lbl_search = Label(Display_Frame, text="Search By", bg="azure", fg="black",font=("arial", 15, "bold"))
		lbl_search.grid(row=0, column=0, pady=10, padx=20, sticky="w")

		combo_search=ttk.Combobox(Display_Frame,textvariable=self.search_by,width=10,font=("arial",10,"bold"),state='readonly')
		combo_search['values']=("Roll_no","Name","Contact")
		combo_search.grid(row=0, column=1, pady=10, padx=20, sticky="w")

		txt_Search = Entry(Display_Frame, textvariable=self.search_txt,font=("arial", 13, "bold"), bd=5, relief=GROOVE)
